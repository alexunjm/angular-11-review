...
import { RenderIfConditionalResultComponent } from './components/example-06/render-if-conditional-result/render-if-conditional-result.component';
...
@NgModule({
  declarations: [
    ...
    RenderIfConditionalResultComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule
